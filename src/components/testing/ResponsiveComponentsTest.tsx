...
export function ResponsiveComponentsTest() {
  ...
  const entityColumns = [
    { id: "name", header: "Name", accessorKey: "name", priority: "high" as const },
    { id: "email", header: "Email", accessorKey: "email", priority: "medium" as const },
  ...
  return (
    <div className="p-4 space-y-8" data-testid="responsive-components-test">
      ...
      <section className="space-y-4" data-testid="responsive-container-test">
      ...
      <section className="space-y-4" data-testid="collapsible-section-test">
      ...
      <section className="space-y-4" data-testid="mobile-entity-list-test">
      ...
      <section className="space-y-4" data-testid="mobile-report-test">
      ...
      <div className="flex justify-center mt-8" data-testid="test-actions">
